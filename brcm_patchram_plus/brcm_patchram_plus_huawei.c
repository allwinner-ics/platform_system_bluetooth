...
unsigned char hci_write_sco_pcm_int[] = { 0x01, 0x1c, 0xfc, 0x05,
       	0x00, // routing to PCM
       	0x04, // 2048Kbps, 0x01 = 256Kbps, 0x02 = 512Kbps, 0x03 = 1024Kbps
    	0x00, // short frame, 0x01 = long frame
	0x00, // sync mode slave, 0x01 = master
	0x00  // clock mode slave, 0x01 = master
};

unsigned char hci_write_pcm_data_format[] = { 0x01, 0x1e, 0xfc, 0x05,
       	0x00, // MSB first, 0x01 = LSB first
	0x00, // fill bits 
	0x00, // fill method
	0x00, // fill num
	0x00  // left justify, 0x01 = right justify
};
...
main (int argc, char **argv)
{
    ...
    hci_send_cmd(hci_write_pcm_data_format, sizeof(hci_write_pcm_data_format));
